...
docker run -d --network=testnet --name=ncp1.docker -v /root/peppol-php/nextcloud-app/peppolnext:/var/www/html/apps/peppolnext ncp1

sleep 15
docker exec -e DBHOST=maria1.docker -e USER=einstein -e PASS=relativity  -u www-data ncp1.docker sh /init.sh
