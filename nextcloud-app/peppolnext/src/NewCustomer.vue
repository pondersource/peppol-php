<template>
	<div class="row">
		...
		<div class="col-6">
			<div class="row">
				<div class="col-10">
					<label for="txt-title">Name:</label>
					<input id="txt-title" v-model="contact.title"> </input>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label for="txt-id">Peppol Identifier</label>
					<input id="txt-id"
						v-model="contact.peppolEndpoint"
						type="text"> </input>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label for="txt-endpoint">AS4 Direct Endpoint</label>
					<input id="txt-endpoint"
						v-model="contact.endpoint"
						type="text"> </input>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-9">
					<div class="row">
						...
						<input id="customer-address-line1" v-model="contact.address.line1"> </input>
					</div>
					<div class="row">
						<label for="customer-address-line2">Line2:</label>
						<input id="customer-address-line2" v-model="contact.address.line2"> </input>
					</div>
					<div class="row">
						<label for="customer-address-city">City:</label>
						<input id="customer-address-city" v-model="contact.address.city"> </input>
					</div>
					<div class="row">
						<label for="customer-address-postcode">PostCode:</label>
						<input id="customer-address-postcode" v-model="contact.address.post_code"> </input>
					</div>
					<div class="row">
						<label for="customer-address-state">State:</label>
						<input id="customer-address-state" v-model="contact.address.state"> </input>
					</div>
					<div class="row">
		...
		submit() {
			...
			axios.post('/index.php/apps/peppolnext/api/v1/contact', payload)
				.then(function(response) {
					...
					this.$router.push('/contact/list/customers')
