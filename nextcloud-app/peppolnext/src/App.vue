		...
		<AppNavigation>
			...
			<template #footer>
				<AppNavigationSettings>
					...
					<div class="row">
						...
						<div class="col-9">
							<div class="row">
								...
								<input id="customer-address-line1" v-model="address.line1"> </input>
							</div>
							<div class="row">
								<label for="customer-address-line2">Line2:</label>
								<input id="customer-address-line2" v-model="address.line2"> </input>
							</div>
							<div class="row">
								<label for="customer-address-city">City:</label>
								<input id="customer-address-city" v-model="address.city"> </input>
							</div>
							<div class="row">
								<label for="customer-address-postcode">PostCode:</label>
								<input id="customer-address-postcode" v-model="address.post_code"> </input>
							</div>
							<div class="row">
								<label for="customer-address-state">State:</label>
								<input id="customer-address-state" v-model="address.state"> </input>
							</div>
							<div class="row">
					...
					<div class="row">
						<button id="setAddress" @click="setAddress">Update address</button>
					</div>
				</AppNavigationSettings>
			</template>
		</AppNavigation>
