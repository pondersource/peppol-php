<template>
	<div class="row">
		...
		<div class="col-9">
			...
			<div class="row">
				<div class="col-5">
					<label for="txt-buyer-ref">Buyer Reference:</label>
					<input id="txt-buyer-ref" v-model="message.buyerReference"> </input>
				</div>
			</div>
			<div class="row">
